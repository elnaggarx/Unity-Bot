  ...
  return (
    <div className="prompt-bar">
      <div className="prompt-bar-inner">
        <div className="prompt-input-contianer">
          <p>🧠</p>
          <input className="prompt-input" placeholder="What’s in your mind?..."></input>
        </div>
        <button className="send-button">
          ...
          <path d="M10.1104 13.6501L13.6904 10.0601" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
